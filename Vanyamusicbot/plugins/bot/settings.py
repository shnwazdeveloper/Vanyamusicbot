...
async def send_repo(_, message: Message):
    await message.reply_video(
        ...
        caption=(
            ...
            "🧡 ᴄʀᴇᴅɪᴛꜱ : <a href='https://t.me/iwantandroid'>@iwantandroid</a>"
        ),
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("🎵 Music + Management Bot Repo", url="https://files.catbox.moe/z7l2yq.mp4")],
                [InlineKeyboardButton("🎧 Only Music Bot Repo", url="https://files.catbox.moe/z7l2yq.mp4")]
            ]
        ),
